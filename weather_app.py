...
def showWeather():
    ...
    # API url
    weather_url = 'http://api.openweathermap.org/data/2.5/weather?q=' + city_name +  "&appid=17076b0b4a1149119c9473c96d4c5cf3"
...
inp_city = Entry(root, textvariable = city_value,  width = 30, font='Arial 14 bold').pack()
